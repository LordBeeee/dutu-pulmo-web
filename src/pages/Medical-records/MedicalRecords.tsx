...
export default function MedicalRecordsPage() {
  ...
  const filteredRecords = useMemo(() => {
    return records.filter((r) => {
      ...
      const matchEnd =
        !endDate ||
        recordDate <= new Date(new Date(endDate).setHours(23, 59, 59));
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-slate-500 mb-6">
        ...
        <span className="font-medium text-slate-900">Hồ sơ bệnh án</span>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Xem và quản lý lịch sử khám bệnh, chẩn đoán và kết quả điều trị
          </p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-200 py-2.5 text-sm pl-10 focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none transition-all"
                  />
                </div>
              </div>
